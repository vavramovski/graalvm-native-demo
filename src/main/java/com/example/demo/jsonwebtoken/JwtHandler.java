...
/**
 * A JwtHandler is invoked by a {@link com.example.demo.jsonwebtoken.JwtParser JwtParser} after parsing a JWT to indicate the exact
...
public interface JwtHandler<T> {
    ...
    /**
     * This method is invoked when a {@link com.example.demo.jsonwebtoken.JwtParser JwtParser} determines that the parsed JWT is
