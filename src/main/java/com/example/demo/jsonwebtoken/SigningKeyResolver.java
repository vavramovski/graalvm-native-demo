...
/**
 * A {@code SigningKeyResolver} can be used by a {@link com.example.demo.jsonwebtoken.JwtParser JwtParser} to find a signing key that
 ...
 * the {@link com.example.demo.jsonwebtoken.SigningKeyResolverAdapter} and overriding only the method you need to support instead of
 * implementing this interface directly.</p>
 *
 * @see com.example.demo.jsonwebtoken.SigningKeyResolverAdapter
 * @since 0.4
 */
