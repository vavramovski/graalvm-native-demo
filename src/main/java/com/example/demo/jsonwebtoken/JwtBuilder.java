...
public interface JwtBuilder extends ClaimsMutator<JwtBuilder> {
     ...
     * header and only want to append to it, use the {@link #setHeaderParams(Map)} method instead.
     *
     ...
     * {@link #setClaims(Claims)} or {@link #setClaims(Map)} methods instead.
     *
     ...
     *
     * <p>This is a convenience method.  It will first ensure a Claims instance exists as the JWT body and then set
     * the Claims {@link Claims#setExpiration(Date) expiration} field with the specified value.  This allows
     ...
     *
     * <p>This is a convenience method.  It will first ensure a Claims instance exists as the JWT body and then set
     * the Claims {@link Claims#setNotBefore(Date) notBefore} field with the specified value.  This allows
     * you to write code like this:</p>
     *
     * <pre>
     ...
     *
     * <p>This is a convenience method.  It will first ensure a Claims instance exists as the JWT body and then set
     * the Claims {@link Claims#setIssuedAt(Date) issuedAt} field with the specified value.  This allows
     * you to write code like this:</p>
     *
     * <pre>
