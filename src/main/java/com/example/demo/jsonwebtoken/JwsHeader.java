...
public interface JwsHeader<T extends JwsHeader<T>> extends Header<T> {
     ...
     * using {@link com.example.demo.jsonwebtoken.SignatureAlgorithm#forName(String) SignatureAlgorithm.forName} to convert this
     ...
     *
     * <p>The algorithm header parameter identifies the cryptographic algorithm used to secure the JWS.  Consider
     * using a type-safe {@link com.example.demo.jsonwebtoken.SignatureAlgorithm SignatureAlgorithm} instance and using its
     * {@link com.example.demo.jsonwebtoken.SignatureAlgorithm#getValue() value} as the argument to this method.</p>
     *
