...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(org.springframework.boot.test.autoconfigure.web.servlet.AutoConfigureMockMvc.class, () -> new org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration());
    factories.add(org.springframework.boot.test.autoconfigure.web.servlet.AutoConfigureMockMvc.class, () -> new org.springframework.boot.autoconfigure.security.servlet.SecurityFilterAutoConfiguration());
    factories.add(org.springframework.boot.test.autoconfigure.web.servlet.AutoConfigureMockMvc.class, () -> new org.springframework.boot.autoconfigure.security.servlet.UserDetailsServiceAutoConfiguration());
    ...
    factories.add(org.springframework.boot.test.autoconfigure.web.reactive.AutoConfigureWebTestClient.class, () -> new org.springframework.boot.autoconfigure.security.reactive.ReactiveUserDetailsServiceAutoConfiguration());
